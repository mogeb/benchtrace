...
def start_tracing(tracename, args, tracepoints = None):
    ...
    print('echo 1 > ' + tracing_dir + 'events/syscalls/sys_enter_ioctl/enable')
    call('echo 1 > ' + tracing_dir + 'events/syscalls/sys_enter_ioctl/enable', shell=True)

    print('echo 1 > ' + tracing_dir + 'events/syscalls/sys_exit_ioctl/enable')
    call('echo 1 > ' + tracing_dir + 'events/syscalls/sys_exit_ioctl/enable', shell=True)
